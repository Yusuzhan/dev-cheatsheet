...
## fa-magnifying-glass DAO (Queries)
...
## fa-pen-to-square DAO (Insert/Update/Delete)
...
## fa-database Room Database Setup
...
## fa-link Relationship (One-to-Many)
...
## fa-arrows-left-right Relationship (Many-to-Many)
...
## fa-exchange-alt Type Converters
...
## fa-wave-square Flow/LiveData Queries
...
## fa-search FTS (Full-Text Search)
