...
## fa-tower-broadcast StateFlow 与 SharedFlow

```kotlin
class MyViewModel : ViewModel() {
    private val _state = MutableStateFlow("初始值")
...
scope.launch {
    launch { throw Error("子协程1失败") }
    launch { delay(100); println("子协程2仍在运行") }
}
