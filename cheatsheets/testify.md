...
func TestDB(t *testing.T) {
    ...
    require.NoError(t, err, "database connection must succeed")
    defer db.Close()
...
## fa-triangle-exclamation Error Assertions
...
## fa-table Table-driven with Testify
