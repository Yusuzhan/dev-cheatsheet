...
## fa-arrow-right Activity Intent 与导航
...
val intent = Intent(Intent.ACTION_SEND).apply {
    type = "text/plain"
    putExtra(Intent.EXTRA_TEXT, "分享这段内容")
}
