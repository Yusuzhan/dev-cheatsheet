...
```javascript
// Browser: no manual ping API, use application-level heartbeat
...
// Node.js server: native ping/pong
...
// Protocol Buffers / MessagePack over WebSocket
...
// Or authenticate via HTTP before upgrade
...
ws.onclose = (event) => {
  switch (event.code) {
    ...
    case 4001: console.log("custom: unauthorized"); break;
  }
};

// Server: close with code
